...
<body>
	...
	<form action="transaction.htm" method="post">
		...
		<jsp:useBean id="userBean" class="com.sapient.model.UpcomingEventList"
			...
			<div class="jumbotron col-lg-8 col-lg-offset-2 form-group"
				...
				<div class="col-xs-4">
					<div class="col-xs-1 checkbox">
						<input type="checkbox" name="transact" value="${item.eventId }">
					</div>
					<div class="col-xs-10">
		...
		<div class="col-lg-12">
			<button class="btn-success btn-lg col-md-offset-11">Confirm</button>
		</div>
	</form>
